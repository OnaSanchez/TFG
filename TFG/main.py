...
# Apply PCA
Pca_application(X.select_dtypes(include=['float64', 'int64']), y, True, 0.8) # Change bool to True for plots
...
plot_heatmap(correlations, best_corr, reduced_corr, all = True, reduced = True, best = True)
...
plot_pairplot(data_corr, show = True)
...
plot_pairplot(log_data_corr, show = True)



# --------------- plots 3d para ver relaciones ---------------

plot_3d_rels(data_corr, best_corr, show = True)
...
regressors = {
    'LINEAR': perform_regression(norm_merged_df, best_corr, 'LINEAR', show_process=False, plot_pred = True),
    'LASSO': perform_regression(norm_merged_df, best_corr, 'LASSO', show_process=False, plot_pred = True),
    'BAYES': perform_regression(norm_merged_df, best_corr, 'BAYES', show_process=False, plot_pred = True),
